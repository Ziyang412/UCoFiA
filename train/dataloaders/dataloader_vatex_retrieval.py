...
class VATEX_DataLoader(Dataset):
    ...
    def __init__(
        ...
        #     self.features_path = os.path.join(self.features_path, "training")
        # else:
        #     self.features_path = os.path.join(self.features_path, "testing_public")
