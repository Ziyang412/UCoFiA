...
class DiDeMo_DataLoader(Dataset):
    def __init__(
        ...
        # print("video_ids_1", len(video_ids))
        ...
        # video_ids = list(set(video_ids) & set(self.caption_dict.keys()))
        video_ids = list(set(video_ids) & set(self.caption_dict.keys()) & set(self.video_dict.keys()))

        # print("video_ids_2", len(video_ids))
...
class DiDeMo_Text_DataLoader(Dataset):
    def __init__(
            self,
            subset,
            data_path,
