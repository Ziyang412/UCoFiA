...
class ActivityNet_DataLoader(Dataset):
    def __init__(
        ...
        # #test case
        # video_id_path_dict = {}
        # video_id_path_dict["train"] = os.path.join(self.data_path, "val_ids_2.json")
        # video_id_path_dict["val"] = os.path.join(self.data_path, "val_ids_2.json")

        # video_json_path_dict = {}
        # video_json_path_dict["train"] = os.path.join(self.data_path, "val_2.json")
        ...
        #print("video id list: {}".format((video_id_list)))
        #print("pseudo caption dict: {}".format((pseudo_caption_dict.keys())))

        video_dict = {}
        # print('video_id_path_dict', self.subset, video_id_path_dict[self.subset])
        # print('video_json_path_dict', self.subset, video_json_path_dict[self.subset])
        # print('pseudo_video_id_list', len(pseudo_video_id_list), pseudo_video_id_list[0])
        # print('video_id_list', len(video_id_list), video_id_list[0])
        ...
        #print('video_dict', len(video_dict), video_dict.keys())
        self.video_dict = video_dict
        #print(self.video_dict)
        #print("video dict: {}".format(len(video_dict)))
        #print("video dict:", video_dict.keys())
