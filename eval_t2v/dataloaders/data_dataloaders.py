...
from dataloaders.dataloader_msrvtt_retrieval import MSRVTT_TrainDataLoader, MSRVTT_Train_Text_DataLoader
from dataloaders.dataloader_msvd_retrieval import MSVD_DataLoader, MSVD_Text_DataLoader
from dataloaders.dataloader_lsmdc_retrieval import LSMDC_DataLoader
from dataloaders.dataloader_activitynet_retrieval import ActivityNet_DataLoader, ActivityNet_Text_DataLoader
from dataloaders.dataloader_didemo_retrieval import DiDeMo_DataLoader, DiDeMo_Text_DataLoader

def dataloader_msrvtt_train(args, tokenizer):
    msrvtt_dataset = MSRVTT_Train_Text_DataLoader(
...
def dataloader_msvd_train(args, tokenizer):
    msvd_dataset = MSVD_Text_DataLoader(
        subset="train",
...
def dataloader_activity_train(args, tokenizer):
    activity_dataset = ActivityNet_Text_DataLoader(
        subset="train",
        data_path=args.data_path,
        features_path=args.features_path,
        max_words=args.max_words,
...
def dataloader_didemo_train(args, tokenizer):
    didemo_dataset = DiDeMo_Text_DataLoader(
        subset="train",
        data_path=args.data_path,
        features_path=args.features_path,
        max_words=args.max_words,
